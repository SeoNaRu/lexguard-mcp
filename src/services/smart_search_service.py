...
from .intent_config import INTENT_KEYWORDS
from .smart_search_lookup_methods import LookupMethodsMixin
...
class SmartSearchService(LookupMethodsMixin):
    """
    ...
    def __init__(self):
        ...
        # 의도 분류 키워드 (intent_config.py 에서 관리)
